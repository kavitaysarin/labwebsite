...
- **Added 2026-07-01 (2 more):** **Chris Sadee** (AI Data Scientist, Staff; sadee@stanford.edu) and **Akash Dhawan, PhD** (Trainees) — both with lab-supplied photos. **Akash's role/title was NOT supplied — set to a placeholder "Postdoctoral Fellow" (TODO: VERIFY); confirm his actual title/category.** Team is now 18.
