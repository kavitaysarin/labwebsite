...
- **Optical Imaging** image (Technologies page) is now a **photo of the DAMAE Medical "deepLive" LC-OCT device** (`damae.jpg`, lab-supplied 2026-07-01). This looks like a **commercial product/marketing photo** — **confirm reuse rights** from DAMAE Medical. (The homepage Optical Imaging card still uses the previous `optical-imaging.jpg` OCT scan.)
