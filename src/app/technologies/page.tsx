    ...
    <main id="main-content">
      ...
      <section className="bg-white">
        <div className="container-wide section-pad">
          <p className="max-w-3xl text-[17px] leading-relaxed text-gray-dark">
            {TECHNOLOGY_INTRO}
          </p>
          ...
          >
            {TECHNOLOGY_PROGRAMS.map((p) => (
              <a
                key={p.slug}
                href={`#${p.slug}`}
                className="card-surface flex items-center gap-3 p-4 transition-[transform,border-color,box-shadow] duration-150 hover:-translate-y-0.5 hover:border-cardinal/40 hover:shadow-card-strong lg:flex-col lg:items-start lg:gap-2"
              >
